            ...
            <ul class="nav__list">
                ...
                <li class="nav__item">
                    ...
                    @guest
                        @if (Route::has('login'))
                            <li class="nav-item">
                                <a class="nav__link" href="{{ route('login') }}">{{ __('Вход') }}</a>
                            </li>
                        @endif

                        @if (Route::has('register'))
                            <li class="nav-item">
                                <a class="nav__link" href="{{ route('register') }}">{{ __('Регистрация') }}</a>
                            </li>
                        @endif
                        @else
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="dropdown-toggle nav__link" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                {{ Auth::user()->name }}
                            </a>
    ...
    <section class="home" id="home">
        ...
        <div class="home__container container grid">
            <div class="home__data">
                <span class="home__data-subtitle">Откройте для себя свое место</span>
                <h1 class="home__data-title">Исследуйте <br> Самые <b>Красивые <br> Пляжи</b></h1>
        ...
        <div class="place__container container grid">
            ...
            <div class="place__card">
                ...
                <div class="place__content">
                    ...
                    <div class="place__data">
                        <h3 class="place__title">Maldives</h3>
                        <span class="place__subtitle">Maldives</span>
